...
{
    return RetentionService::retention_allowed_targets();
}
...
{
    return RetentionService::retention_cutoff($days);
}
...
function retention_drop_metrics_partitions(string $cutoff): int
{
    return RetentionService::retention_drop_metrics_partitions($cutoff);
}
...
{
    return RetentionService::run_retention_cleanup($days);
}
