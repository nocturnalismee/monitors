...
<script<?= csp_nonce_attr() ?>>window.MONITORS_PING_DETAIL = <?= json_encode(['endpoint' => app_url('api/ping-detail'), 'id' => $id, 'range' => $range, 'page' => $page], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;</script>
